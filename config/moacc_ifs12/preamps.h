...
/* Here we document IFS parameters that differ between
   instruments. [These values are for SN #091, aka IFS11]
   ...
   Values as of 10/4/2016: There is no Si detector installed,
...
#define IFS_SELECT_InGaAs "DTC=0x4021"
#define IFS_SELECT_Si     "DTC=0x4021"
// IFS_SELECT_Si     "DTC=0x40C1"
